...
// 1. 영문자, 숫자, 특수문자(_또는 $)를 조합하여 작성 - Java에서는 한글을 식별자로 권장 X
// 2. 숫자로 시작되도록 작성 불가능
// 3. 영문자는 대소문자를 구분하여 작성
// 4. 기존에 사용된 단어(키워드 또는 식별자)를 식별자로 사용 불가능

// - Java에서 사용하는 식별자 작성 표기법 (약속) - 영문자의 소문자를 기본으로 식별자 작성

// 1. 파스칼 표기법(PascalCase) : 조합된 단어의 첫문자를 대문자로 표현하여 식별자 작성
//    -> 클래스명, 인터페이스명 작성 시 사용 ex) VariableApp, HelloWorld 
// 2. 카멜 표기법(CamelCase) :  첫번째 단어를 제외한 조합된 단어의 첫문자를 대문자로 표현하여 식별자 작성
//    -> 변수명, 메소드명 작성 시 사용 , 기본 표기법
// 3. 스네이크 표기법(SnakeCase) : 조합된 단어를 _ 로 구분하여 식별자 작성
//    -> 상수 작성 시 사용 (java에서 상수는 대문자로 작성)
